...
Built fast, but built with depth.

---

## ✨ Features

### 1. 🎯 Goal-Based Vocabulary Engine
...
### 2. 📖 Reading Mode (Speaking + Speed Control)
...
### 3. 🎙️ Full Speaking Evaluation Pipeline
...
⏱️ End-to-end processing in under ~20 seconds  
...
- Groq API  
- LLaMA 3.3 70B  
- Custom prompt engineering (structured outputs)
...
- Monotonic cursor system (prevents reset issues)
...
Fluento is built on a simple idea:
